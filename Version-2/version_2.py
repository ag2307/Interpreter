...
class ConditionExpression:
	def build(string):
		...
		raise SyntaxError("No such condition expression found !!")
...
class Expression:
	def build(string):
		...
		if string.find("-")>=0:
			...
			return ConstantExpression(string)
		raise SyntaxError("No such expression found !!")
...
class MultiplicationExpression:
	...
	def eval(self,state):
		try:
			...
			raise TypeError("Types mismatched !!")
...
if __name__ == '__main__':
	...
	print("Parsing time is : ",start-start1,"seconds")
	print("Eval(or execution) time is : ",end-start,"seconds")
	print(state)
